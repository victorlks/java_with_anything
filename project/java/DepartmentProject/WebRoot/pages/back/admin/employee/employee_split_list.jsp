...
String location = basePath + "pages/back/admin/employee/" + "employee_split_list.jsp";
%>
...
%>
<%
	List<Employee> all = (List<Employee>)ServiceFactory.getIEmployeeServiceInstance().list(currentPage, lineSize, column, keyWord).get("all");
	Long allRecorders = (Long)ServiceFactory.getIEmployeeServiceInstance().list(currentPage, lineSize, column, keyWord).get("allRecorders");
 %>
